...
* Студент: [Неопознанный Квокка](https://up.htmlacademy.ru/htmlcss/37/user/475753).
* Наставник: `Неизвестно`.TEEEEEST
...
[Откройте мастер-репозиторий](https://github.com/htmlacademy-htmlcss/475753-sedona-37) и нажмите кнопку «Fork» в правом верхнем углу. Репозиторий из Академии скопируется в ваш аккаунт.
